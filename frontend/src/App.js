  ...
  return (
    <div className="app-container game-active">
      ...
      <div className="tab-content-area">
        ...
        {/* Persistent Demo Overlay */}
        {demoActive && (
          <div className="demo-overlay-container" style={{ position: 'absolute', top: 60, left: 0, right: 0, bottom: 0, zIndex: 2000, pointerEvents: 'none' }}>
            <DemoMode
              active={true}
              gameState={gameState}
